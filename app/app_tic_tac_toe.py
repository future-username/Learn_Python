...
# root = Tk()
#
# root.title("Tic-tac-toe v.01")
#
# button_11 = Button()
# button_11.grid(column=1, row=1, ipadx=40, ipady=60)
# button_12 = Button()
# button_12.grid(column=2, row=1, ipadx=40, ipady=60)
# button_21 = Button()
# button_21.grid(column=1, row=2, ipadx=40, ipady=60)
# button_11 = Button()
# button_11.grid(column=2, row=2, ipadx=40, ipady=60)
#
#
# root.mainloop()
...
# button_22 = Button(command=button_click_22)
# button_22.grid(column=2, row=2, ipadx=40, ipady=60)
# Button(text="NEW GAME", command=create_game).grid(column=1, row=3, columnspan=2, sticky=NSEW)
#
#
# root.mainloop()
...
# root = Tk()
#
# root.title("Tic-tac-toe v.06")
#
# button_11 = Button(command=button_click_11, fg="black")
# button_11.grid(column=1, row=1, ipadx=40, ipady=60)
# button_12 = Button(command=button_click_12, fg="black")
# button_12.grid(column=1, row=2, ipadx=40, ipady=60)
# button_21 = Button(command=button_click_21, fg="black")
# button_21.grid(column=2, row=1, ipadx=40, ipady=60)
# button_22 = Button(command=button_click_22, fg="black")
# button_22.grid(column=2, row=2, ipadx=40, ipady=60)
# Button(text="NEW GAME", command=create_game, fg="black").grid(column=1, row=3, columnspan=2, sticky=NSEW)
#
#
# root.mainloop()
...
#     # print('Diagonal 11-22:', button_11["text"] == "X" and button_22["text"] == "X")
#     # print('Diagonal 12-21:', button_12["text"] == "X" and button_21["text"] == "X")
#     if button_11["text"] == "X" and button_21["text"] == "X" or\
#             button_12["text"] == "X" and button_22["text"] == "X" or\
#             button_11["text"] == "X" and button_12["text"] == "X" or\
#             button_21["text"] == "X" and button_22["text"] == "X" or\
#             button_11["text"] == "X" and button_22["text"] == "X" or\
#             button_12["text"] == "X" and button_21["text"] == "X":
#         print("X - won!")
#
#
# root = Tk()
#
# root.title("Tic-tac-toe v.07")
#
# button_11 = Button(command=button_click_11, fg="black")
# button_11.grid(column=1, row=1, ipadx=40, ipady=60)
# button_12 = Button(command=button_click_12, fg="black")
...
#             button_12["text"] == "X" and button_21["text"] == "X":
#         print("X - won!")
#     elif button_11["text"] == "0" and button_21["text"] == "0" or\
#             button_12["text"] == "0" and button_22["text"] == "0" or\
#             button_11["text"] == "0" and button_12["text"] == "0" or\
#             button_21["text"] == "0" and button_22["text"] == "0" or\
#             button_11["text"] == "0" and button_22["text"] == "0" or\
#             button_12["text"] == "0" and button_21["text"] == "0":
#         print("0 - won!")
#
#
# root = Tk()
#
# root.title("Tic-tac-toe v.08")
#
# button_11 = Button(command=button_click_11, fg="black")
# button_11.grid(column=1, row=1, ipadx=40, ipady=60)
# button_12 = Button(command=button_click_12, fg="black")
